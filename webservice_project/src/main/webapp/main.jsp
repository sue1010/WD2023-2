...
*{
 ...
 #sub_menu li {
 		padding: 10px;
 		border-bottom: dotted 1[x #cccccc;
 }
 #main_contents {
 		width: 880px;
 		float: right;
...
<section id = 'contents'>
	...
	<div id = 'amin_contents'>
		...
		<p>그림은 하드웨어 위에 커널(kernel)이 올라가고, 커널 위에서 
		셸(shell)과 애플리케이션(application)이 실행된다. 사용자는 기본적으로 셸을 통해 
		...
		<ul>
			...
			<li>③ 부트로더 : 컴퓨터가 켜졌을 때 운영체제에 필요한 조치를 취하고 하드 디스크 드라이브에 기록되어 있는 운영체제를 실행하는 
			프로그램이다</li></ul>
	</div>
</section>
